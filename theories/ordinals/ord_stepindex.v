...
From category Require Import stepindex set_model set_sets set_ordinals.
...
Section ord_definition.
  ...
  (** Step-Index Instance *)
  (* Transitivity *)
  Local Instance ord_lt_trans : Transitive ord_lt.
  Proof.
...
Section set_ordinal_lemmas.
  ...
  Qed.
  Local Hint Immediate ordinals_lt : core.
