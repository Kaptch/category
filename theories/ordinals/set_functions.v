...
From category.ordinals Require Import set_model set_sets.
...
- apply zf_replacement. exists p. split.
...
- apply zf_replacement. exists (x,y). split.
...
Proof.
  intros I [I' I'']. assert (F: function f A B).
  - split; eauto.
