...
End index_laws.
Local Arguments index_zero_least : clear implicits.
Local Arguments index_lt_wf : clear implicits.
...
Local Arguments limit_idx : clear implicits.
Local Arguments mklimitidx {_}.
...
Local Hint Resolve <- index_succ_iff : core.
...
Section pair_index.
  ...
  Local Instance pair_lt_trans: Transitive pair_lt.
  Proof.
...
Create HintDb index.
Local Hint Extern 1 False => eapply index_lt_irrefl : index.
Local Hint Resolve -> index_succ_iff : index.
Local Hint Constructors rc : index.
(* TODO: maybe remove the transitivity stuff *)
Local Hint Extern 2 (_ ≺ _) => etransitivity : index.
Local Hint Resolve index_le_lt_trans : index.
Local Hint Resolve index_lt_le_trans : index.
Local Hint Resolve index_succ_greater : index.
Local Hint Resolve index_le_succ_inj : index.
Local Hint Resolve index_lt_succ_mono : index.
Local Hint Immediate index_zero_minimum : index.
