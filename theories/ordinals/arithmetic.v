...
Section ordinals.
  ...
  Section well_founded.
    ...
    Local Arguments next {_} _.
    Local Arguments successors_of {_} _.
    Local Arguments is_successor {_} _.
  ...
  End well_founded.
  Local Arguments next {_ _ _} _.
  Local Arguments successors_of {_ _ _} _.
  Local Arguments is_successor {_ _ _} _.
  ...
  Section element_order.
    ...
    Proof.
      ...
      { eapply ordinal_trans; eauto using elements_in, ordinal_el.
        - eapply (ordinal_el (ordinals α x)); last done.
          eapply ordinal_el; [| apply ordinals_lt].
          apply ord_set_is_ordinal.
        - eapply ordinal_el; [| apply ordinals_lt].
          apply ord_set_is_ordinal.
        - apply ord_set_is_ordinal.
        - apply ordinals_lt. }
    ...
    Proof.
      ...
      - destruct (nat_add_inv _ _ _ (ordinals_lt _ ab)) as [δ [[Hδα Hlt]|[Hδβ Hlt]]].
        ...
        + specialize (IHβ _ Hδβ). apply succ_least_greater.
          ...
          by eapply natural_addition_strict_compat.
      - etransitivity.
        + eapply succ_mono_leq, IHγ; auto; first apply ordinals_lt.
  ...
  Local Arguments tc_once {_ _ _ _} _.
  Local Arguments tc_l {_ _ _ _ _} _.
  Local Arguments interleave_L {_ _ _ _ _ _ _} _.
  Local Arguments interleave_R {_ _ _ _ _ _ _} _.
  ...
  Proof.
    intros H1 H2.
    destruct (ord_linear α β) as [H|[H|H]]; auto.
...
Section ordinal_multiplication.
  ...
  Lemma omul_zero: (zero : Ord) = omul zero.
  Proof.
    apply ord_leq_eq; split.
    - unfold index_le.
      rewrite ord_leq_unfold.
      intros ? H.
      exfalso.
      unfold ord_set in H.
      simpl in H.
      now apply (zf_existence x).
